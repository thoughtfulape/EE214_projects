...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 1/requirement_5/requirement_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sseg_control.tcl
