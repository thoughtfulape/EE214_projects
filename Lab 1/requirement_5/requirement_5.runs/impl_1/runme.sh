...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 1/requirement_5/requirement_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sseg_control.tcl -notrace
