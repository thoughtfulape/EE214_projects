...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 8/requirement_2/requirement_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log req2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source req2.tcl -notrace
