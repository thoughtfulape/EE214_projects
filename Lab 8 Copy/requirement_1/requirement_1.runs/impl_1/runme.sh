...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 8/requirement_1/requirement_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_divider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_divider.tcl -notrace
