...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 3/requirement_3/requirement_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_indicator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source temp_indicator.tcl -notrace
