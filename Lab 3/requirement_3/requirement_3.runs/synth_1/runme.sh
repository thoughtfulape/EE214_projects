...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 3/requirement_3/requirement_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_indicator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temp_indicator.tcl
