...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 3/requirement_1/requirement_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log five_way_switch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source five_way_switch.tcl
