...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 3/requirement_1/requirement_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log five_way_switch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source five_way_switch.tcl -notrace
