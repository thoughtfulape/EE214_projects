...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 3/challenge_1/challenge_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log odd_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source odd_detector.tcl
