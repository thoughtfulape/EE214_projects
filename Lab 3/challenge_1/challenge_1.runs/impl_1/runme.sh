...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 3/challenge_1/challenge_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log odd_detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source odd_detector.tcl -notrace
