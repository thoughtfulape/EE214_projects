...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 3/requirement_2/requirement_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log majority_of_five.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source majority_of_five.tcl -notrace
