...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 3/requirement_2/requirement_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log majority_of_five.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source majority_of_five.tcl
