...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 9/requirement_3/requirement_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log req3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source req3_wrapper.tcl -notrace
