...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 9/requirement_4/requirement_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comparator.tcl -notrace
