...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 9/requirement_1/requirement_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_4_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLA_4_bit.tcl
