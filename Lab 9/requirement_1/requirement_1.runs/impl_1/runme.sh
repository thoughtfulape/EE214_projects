...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 9/requirement_1/requirement_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_4_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CLA_4_bit.tcl -notrace
