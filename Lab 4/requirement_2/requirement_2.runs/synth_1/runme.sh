...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 4/requirement_2/requirement_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log requirement_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source requirement_2.tcl
