...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 8/requirement_2/requirement_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log req2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source req2.tcl
