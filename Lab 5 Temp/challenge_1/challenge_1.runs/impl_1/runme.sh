...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 5 Temp/challenge_1/challenge_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log challenge_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source challenge_1_wrapper.tcl -notrace
