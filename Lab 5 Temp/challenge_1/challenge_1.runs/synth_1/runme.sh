...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 5 Temp/challenge_1/challenge_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log challenge_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source challenge_1_wrapper.tcl
