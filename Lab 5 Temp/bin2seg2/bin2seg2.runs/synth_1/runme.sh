...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 5 Temp/bin2seg2/bin2seg2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin2seg2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin2seg2.tcl
