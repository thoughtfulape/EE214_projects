...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 5 Temp/bin2seg2/bin2seg2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bin2seg2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bin2seg2.tcl -notrace
