...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 5 Temp/single_seg_b/single_seg_b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_seg.tcl
