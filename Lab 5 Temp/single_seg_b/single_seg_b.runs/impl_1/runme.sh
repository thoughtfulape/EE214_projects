...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 5 Temp/single_seg_b/single_seg_b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log single_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source single_seg.tcl -notrace
