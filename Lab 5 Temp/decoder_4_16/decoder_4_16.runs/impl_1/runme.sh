...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 5 Temp/decoder_4_16/decoder_4_16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_4_16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_4_16.tcl -notrace
