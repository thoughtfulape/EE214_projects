...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 4/requirement_2/requirement_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log requirement_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source requirement_2.tcl -notrace
