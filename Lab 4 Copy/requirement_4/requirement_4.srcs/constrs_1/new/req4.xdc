...
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { Eout }]; #IO_L22N_T3_34 Schematic=LD9


# Switches
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { Ein }]; #IO_L19N_T3_VREF_34 Schematic=SW0
...
#Push Buttons
# set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { Ein }]; #IO_L8P_T1_34 Schematic=BTN0
