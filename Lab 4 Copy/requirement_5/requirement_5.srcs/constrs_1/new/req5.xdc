...
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { Y[8] }]; #IO_L16P_T2_34 Schematic=LD8
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { Y[9] }]; #IO_L22N_T3_34 Schematic=LD9
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { Y[10] }];
...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { I[8] }]; #IO_L10P_T1_34 Sch=VGA_R4_CON
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { I[9] }]; #IO_L10N_T1_34 Sch=VGA_R5_CON
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { I[10] }]; #IO_L18P_T2_34 Sch=VGA_R6_CON
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { F }]; #IO_L18N_T2_AD13N_35 Sch=VGA_R7_CON
...
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { D }]; #IO_L24P_T3_34 Schematic=BTN2
