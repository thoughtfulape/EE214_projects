...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 7/requirement_5/requirement_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log piso_shifter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source piso_shifter.tcl
