...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 7/requirement_5/requirement_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log piso_shifter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source piso_shifter.tcl -notrace
