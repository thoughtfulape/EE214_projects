...
HD_PWD='D:/Libraries/Documents/Vivado Projects/Lab 7/requirement_4/requirement_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipo_shifter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pipo_shifter.tcl -notrace
